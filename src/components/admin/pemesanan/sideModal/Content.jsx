...
export default ({onClose}) => {
    return (
        ...
        <div className="h-full w-4/6 mx-auto flex gap-3">
            ...
            <section className="basis-4/6">
                ...
                <div className="p-3">
                    <div className="border rounded p-3 font-semibold text-yellow-800 border-yellow-500 bg-yellow-200">
                        Baru
                    </div>
                </div>
                <div className="flex flex-col gap-2">
                    <div className="flex ">
                        ...
                        <p className="basis-1/2 font-semibold">tamu icikiwin</p>
                    </div>
                    <div className="flex ">
                        <p className="basis-1/2 text-gray-500">Email Pemesan</p>
                        <p className="basis-1/2 font-semibold">icikir@djawir.con</p>
                    </div>
                    <div className="flex ">
                        <p className="basis-1/2 text-gray-500">Nama tamu</p>
                        <p className="basis-1/2 font-semibold">iwir iwir</p>
                    </div>
                    <div className="flex ">
                        <p className="basis-1/2 text-gray-500">Tanggal Check In</p>
                        <p className="basis-1/2 font-semibold">12- 0 12</p>
                    </div>
                    <div className="flex ">
                        <p className="basis-1/2 text-gray-500">Tanggal Check Out</p>
                        <p className="basis-1/2 font-semibold">12 - 12 - 12</p>
                    </div>
                    <div className="flex ">
                        <p className="basis-1/2 text-gray-500">Tanggal Pemesanan</p>
                        <p className="basis-1/2 font-semibold">13 - maret - 2022</p>
                    </div>
                </div>
